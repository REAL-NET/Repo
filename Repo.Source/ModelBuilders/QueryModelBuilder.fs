...
type QueryModelBuilder() =
    interface IModelBuilder with
        member this.Build(repo: IRepo): unit =
            ...
            infrastructure.Element.SetAttributeValue sort "xCoordinate" "100"
            ...
            infrastructure.Element.SetAttributeValue aggregate "xCoordinate" "100"
            ...
            infrastructure.Element.SetAttributeValue join "xCoordinate" "100"
            ...
            infrastructure.Element.SetAttributeValue read1 "xCoordinate" "50"
            ...
            infrastructure.Element.SetAttributeValue read2 "xCoordinate" "150"
